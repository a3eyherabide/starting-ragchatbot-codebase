...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_generate_response_without_tools(self, mock_anthropic_class):
        ...
        mock_client.messages.create.return_value = MockResponse("Direct response without tools")
    ...
    def test_generate_response_with_tools_no_usage(self, mock_anthropic_class):
        ...
        mock_client = Mock()
        mock_anthropic_class.return_value = mock_client
        mock_client.messages.create.return_value = MockResponse("Response without using tools")
    ...
    def test_generate_response_with_tool_usage(self, mock_anthropic_class):
        ...
        mock_tools = [{"name": "search_course_content", "description": "Search tool"}]
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.return_value = "Course content about MCP concepts"
    ...
    def test_generate_response_with_conversation_history(self, mock_anthropic_class):
        ...
        mock_client = Mock()
        mock_anthropic_class.return_value = mock_client
        mock_client.messages.create.return_value = MockResponse("Response with history context")
    ...
    def test_multiple_tool_calls(self, mock_anthropic_class):
        ...
        initial_response = MockResponse(
            stop_reason="tool_use",
            tool_calls=[tool_use_block1, tool_use_block2]
        )
    ...
    def test_sequential_two_round_tool_calling(self, mock_anthropic_class):
        ...
        round2_response = MockResponse(
            stop_reason="tool_use",
            tool_calls=[round2_tool_block]
        )
        
        # Mock final response: AI synthesizes information
        final_response = MockResponse("Based on the course outline and lesson content, here's what lesson 4 covers...")
        ...
        mock_tool_manager.execute_tool.assert_any_call("search_course_content", query="lesson 4 content", course_name="MCP Course")
    ...
    def test_single_round_completion_no_second_tool(self, mock_anthropic_class):
        ...
        final_response = MockResponse("Based on the search results, here's what I found about basic concepts...")
        ...
        mock_tool_manager = Mock()
        mock_tool_manager.execute_tool.return_value = "Search results about basic concepts"
    ...
    def test_max_two_rounds_limit(self, mock_anthropic_class):
        ...
        tool_block1 = MockToolUseBlock("search_course_content", {"query": "first search"}, "id1")
        tool_block2 = MockToolUseBlock("search_course_content", {"query": "second search"}, "id2")
