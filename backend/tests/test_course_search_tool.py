...
class TestCourseSearchTool(unittest.TestCase):
    ...
    def test_execute_basic_query(self):
        ...
        self.assertEqual(self.search_tool.last_sources[0]["text"], "Introduction to MCP - Lesson 1")
    ...
    def test_execute_with_both_filters(self):
        ...
        result = self.search_tool.execute("specific query", course_name="Specific Course", lesson_number=5)
    ...
    def test_execute_with_empty_results(self):
        ...
        # Execute search with both filters
        result = self.search_tool.execute("nonexistent", course_name="Missing", lesson_number=99)
        self.assertEqual(result, "No relevant content found in course 'Missing' in lesson 99.")
