...
class TestVectorStore(unittest.TestCase):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_with_proper_max_results(self, mock_embedding_func, mock_client_class):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_course_name_resolution_failure(self, mock_embedding_func, mock_client_class):
    ...
    def test_search_with_filters(self, mock_embedding_func, mock_client_class):
        ...
        results = vector_store.search("test query", course_name="Test Course", lesson_number=3)
